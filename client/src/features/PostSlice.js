...
export const getPosts=createAsyncThunk("posts/getPosts",async()=>{
    try{
        const response=await axios.get("https://postitapp-sem-2025.onrender.com/getPosts");
...
export const savePost=createAsyncThunk("posts/savePost",async(pdata)=>{
    try{
        const response=await axios.post("https://postitapp-sem-2025.onrender.com/savePost",pdata);
...
export const updatePost=createAsyncThunk("posts/updatePost",async(pdata)=>{
    try{
        const response=await axios.put("https://postitapp-sem-2025.onrender.com/updatePost",pdata);
...
export const delPost=createAsyncThunk("posts/delPost",async(pid)=>{
    try{
        const response=await axios.delete(`/delPost/${pid}`);
        return response.data;
    }
    catch(error){
        console.log(error);
